...
<head>
    ...
    <style>
        ...
        *, body {padding: 0px;margin: 0px;color: white;font-family: "微软雅黑";}
        ...
        .boxall:before,
        .boxall:after{  width: .1rem; height: .1rem; content: "";  border-top: 2px solid #02a6b5; top: 0;}
        ...
        .boxfoot{ bottom: 0; width: 100%; left: 0;}
        .boxfoot:before,
        .boxfoot:after{  width: .1rem; height: .1rem;  content: "";border-bottom: 2px solid #02a6b5; bottom: 0;}

        .bar{background:rgba(101,132,226,.1); padding: .15rem;}
        .barbox li,.barbox2 li{ width:50%; text-align: center; position: relative; }
        .barbox:before,
        .barbox:after{  width: .3rem; height: .1rem; content: ""; }
